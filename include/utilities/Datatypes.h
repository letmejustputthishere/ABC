#ifndef AST_OPTIMIZER_INCLUDE_UTILITIES_DATATYPES_H_
#define AST_OPTIMIZER_INCLUDE_UTILITIES_DATATYPES_H_
...
#endif //AST_OPTIMIZER_INCLUDE_UTILITIES_DATATYPES_H_
